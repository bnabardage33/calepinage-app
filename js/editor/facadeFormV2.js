...
class FacadeForm {
    ...
    constructor(engine) {
        ...
        alert("FICHIER V2 CHARGÉ — " + new Date().toISOString());
    ...
    handleSubmit() {
        ...
        alert(
            "DIAGNOSTIC CRÉATION\n" +
            "x=" + facade.x + " y=" + facade.y + "\n" +
            "width=" + facade.width + " height=" + facade.height + "\n" +
            "nb objets total=" + this.engine.objectManager.getAll().length + "\n" +
            "engine.width=" + this.engine.width + " engine.height=" + this.engine.height
        );
        ...
        alert(
            "DIAGNOSTIC CAMÉRA APRÈS FIT\n" +
            "zoom=" + this.engine.camera.zoom + "\n" +
            "camera.x=" + this.engine.camera.x + " camera.y=" + this.engine.camera.y
        );
